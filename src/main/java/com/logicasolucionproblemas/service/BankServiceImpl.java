...
import com.logicasolucionproblemas.model.CheckingAccount;
import com.logicasolucionproblemas.model.Customer;
import com.logicasolucionproblemas.model.Money;
import com.logicasolucionproblemas.model.SavingAccount;
...
public class BankServiceImpl implements BankService {
    ...
    public Account createSavingsAccount(String accountId, Customer customer, double interestRate) {
        SavingAccount account = new SavingAccount(accountId, customer, new Money(0.0, "USD"), interestRate);
